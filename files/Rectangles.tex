...
There is a strong hint of the answer in Martin Gardner's version of this problem,  for which he gives this diagram:
\begin{center} \includegraphics [scale=0.3] {gardner1.png} \end{center}

As in so many problems, the key is to draw an inspired diagram, one that extends the figure somehow.  Here, another major hint was provided, namely, a grid of squares.
