...
\begin{center} \includegraphics [scale=0.35] {excircle_intro1.png} \end{center}
...
\begin{center} \includegraphics [scale=0.3] {excircle_intro3.png} \end{center}
...
Since $BI$ bisects $B$, while $BI_a$ bisects the external angle at $B$, namely $\angle CBD$, it follows that $IBI_a$ is a right angle.  Therefore the other angles at $B$ add up to 90 and so they are also complementary:
\[ \angle ABI + \angle IaBD = 90 \]

\begin{center} \includegraphics [scale=0.3] {excircle_intro3.png} \end{center}

Let the perpendicular from $I$ meet $AB$ at $Z$ and consider $\triangle IZB$ which is a right triangle.

Comparing with $\triangle BDI_a$ and remembering the angles we found complementary, we see that the two triangles are similar:

\[ \triangle IZB \sim \triangle BDI_a \]

\begin{center} \includegraphics [scale=0.35] {excircle_crop5.png} \end{center}

This has a number of consequences that we'll come back to in the next book.

\subsection*{intersection of side $a$ and the bisector of $A$}

One neat property of the excircle can be seen more easily with an obtuse angle at $B$ or $C$.  We choose $B$.

\begin{center} \includegraphics [scale=0.3] {excircle_intro4.png} \end{center}
...
Finally, extend $ST$ to meet side $AC$ at $B'$ and go back to meet the extension of side $AB$ at $C'$.
...
So $AB = AB'$, $B = B'$, and then by sum of angles $C = C'$.

It follows that $\triangle ABC \cong \triangle AB'C'$ by ASA.
