...
Probably the most fundamental idea concerning triangles is how to decide whether two triangles are \emph{congruent}.  With congruent triangles all 3 pairs of angles have the same measure, and the corresponding sides have the same length.
